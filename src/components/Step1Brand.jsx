    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          ...
          {/* Fetch as primary CTA */}
          <button
            type="button"
            onClick={triggerScrape}
            disabled={scraperState.loading}
            className="mt-3 w-full py-3 bg-gradient-to-r from-blue-900 to-blue-600 hover:from-blue-800 hover:to-blue-500 disabled:opacity-60 text-white text-sm font-bold rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2.5 shadow-md shadow-blue-500/20 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5"
          >
            {scraperState.loading ? (
              ...
              <>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <path d="M2.5 8h11M8 2.5a9 9 0 010 11M8 2.5a9 9 0 000 11" />
                </svg>
                Fetch Brand Details ✦
              </>
            )}
